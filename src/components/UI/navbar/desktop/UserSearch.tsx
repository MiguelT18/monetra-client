      ...
      <div className="relative">
        ...
        {query && (
          <button
            ...
            className="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition-colors cursor-pointer"
          >
            <FiX size={16} />
          </button>
        )}
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-1 bg-surface border border-border rounded-xl shadow-xl dark:shadow-black/40 overflow-hidden z-50"
          >
            {loading ? (
